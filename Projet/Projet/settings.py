...
SECRET_KEY = 'django-insecure-(85#3&d@42ualk$bk-i6w6w8x_$c-5677+-=7w$58@$&7=a-t#'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'template'],  # Add global template directory here
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Optional: If you have a specific directory for static files in your project
STATICFILES_DIRS = [
    BASE_DIR / "static",
]
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'omarriahi2003@gmail.com'
EMAIL_HOST_PASSWORD = 'agqehehtkjgxnrdy'